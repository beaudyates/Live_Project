...
namespace JobBoardMVC.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    // Added this to differentiate Admin Login - see below
        ...
        // This method should properly redirect Admin to Admin page
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
				...
				//need to include Email = model.Email or validation will fail
                var user = new User { UserName = model.Email, Email = model.Email, Location = model.Email };
